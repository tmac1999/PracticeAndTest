...
/**
 * Created by mrz on 17/11/6.
 */

public class PathRoundView extends AppCompatImageView {
    ...
    public PathRoundView(Context context) {
        super(context);
    }

    public PathRoundView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PathRoundView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
